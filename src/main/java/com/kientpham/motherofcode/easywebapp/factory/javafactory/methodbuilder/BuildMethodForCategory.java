...
public class BuildMethodForCategory extends MethodBuilderBase{

	@Override
	public String buildMethodForRepository(TransactionModel transaction) {
		return super.buildMethodForRepository(transaction)+ String.format(
	...
	public String buildMethodForDBGatewayInterface(TransactionModel transaction) {
		...
		return super.buildMethodForDBGatewayInterface(transaction)+ String.format("	public List<%1$s> findByCategoryGroup(String categoryGroup);\r\n" + 
				"\r\n" + 
	...
	public String buildMethodForDBGateway(TransactionModel transaction) {
		...
		return super.buildMethodForDBGateway(transaction) + String.format("	@Override\r\n" + 
	...
	public String buildMethodForBusinessObject(TransactionModel transaction) {
		return super.buildMethodForBusinessObject(transaction)+ String.format("	public List<%1$s> findAllSorted() {		\r\n" + 
